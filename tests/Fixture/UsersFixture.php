...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['tipo'], 'references' => ['funcoes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'tipo' => 1,
            'stat' => 1,
            'created' => '2016-05-13 16:33:59',
            'modified' => '2016-05-13 16:33:59'
        ],
    ];
}

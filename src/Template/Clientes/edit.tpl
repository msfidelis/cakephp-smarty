    ...
    <div class="card">
        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="/clientes/edit" aria-controls="Novo"  aria-expanded="false">Editar</a></li>
                <li role="presentation" class=""><a href="/clientes/view/{$cliente->id}" aria-controls="Detalhes" aria-expanded="false">Detalhes</a></li>
            </ul>
            <!-- Tab panes -->
